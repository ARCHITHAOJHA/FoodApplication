...
const persistActiveRestaurantId = (payload) => {
    if (payload?.id != null) {
        localStorage.setItem("activeRestaurantId", String(payload.id));
    }
};
...
const restaurantReducer = (state = initialState,action) => {
    switch(action.type){
        ...
        case actionTypes.GET_RESTAURANTS_BY_USER_ID_REQUEST:
        ...
        case actionTypes.CREATE_RESTAURANT_SUCCESS:
            persistActiveRestaurantId(action.payload);
            return{
                ...state,
                loading:false,
